...
let buttonEdit = document.querySelector('.profiles_buttons_edit');
let buttonSave = document.querySelector('.popup_buttons_save');
let popupClose = document.querySelector('.popup_buttons_close');
